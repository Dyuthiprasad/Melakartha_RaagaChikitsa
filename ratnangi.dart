...
class RatnangiScreen extends StatefulWidget {
  const RatnangiScreen({super.key});

  @override
  State<RatnangiScreen> createState() => _RatnangiScreenState();
}

class _RatnangiScreenState extends State<RatnangiScreen> {
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              _buildBenefitRow('Promotes clarity of thought and decision-making.'),
              _buildBenefitRow('Supports a sense of courage and inner strength.'),
              _buildBenefitRow('Helps in overcoming mental obstacles and negativity.'),
              _buildBenefitRow('Encourages assertiveness and self-confidence.'),
              const SizedBox(height: 16),
              Text('Physical Health Benefits:', style: TextStyle(color: brown, fontSize: screenWidth * 0.05)),
              const SizedBox(height: 8),
              _buildBenefitRow('Potentially boosts energy levels and reduces fatigue.'),
              _buildBenefitRow('May support a healthy metabolism due to its dynamic nature.'),
              _buildBenefitRow('Could indirectly aid in releasing pent-up emotions that can affect physical health.'),
              _buildBenefitRow('Might invigorate the circulatory system due to its lively character.'),
            ],
          ),
        ),
      ),
